...
//
const BotName = 'BACKUP Limpurra -_-'; // Nome do Whatsapp Bot
const grupch1 = 'https://wa.me/+55219804-8330'; // Esse é o meu criador kk
//
const
{
   WAConnection,
...
axios.get(`http://scrap.terhambar.com/yt?link=${teks}`).then((res) => {
    let hasil = `Baixe você mesmo através do link abaixo, infelizmente o servidor está fora do ar affs\n\nSize: ${res.data.filesize}\n\nLink: ${res.data.linkAudioOnly}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
